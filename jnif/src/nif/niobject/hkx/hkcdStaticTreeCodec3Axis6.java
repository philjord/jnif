...
public class hkcdStaticTreeCodec3Axis6 extends hkcdStaticTreeCodec3Axis {
	...
	int hiData;
	int loData;
	public hkcdStaticTreeCodec3Axis6(HKXReaderConnector connector, ByteBuffer stream, int classOffset) throws IOException, InvalidPositionException
	{
		...
		//<member name='loData' type='hkUint16' offset='4' vtype='TYPE_UINT16' vsubtype='TYPE_VOID' arrsize='0' flags='FLAGS_NONE'/>
		loData = Short.toUnsignedInt(stream.getShort(classOffset + 4));		
	}
}