...
public class hkcdStaticTreeDynamicStoragehkcdStaticTreeCodec3Axis4 {
	...
	public hkcdStaticTreeDynamicStoragehkcdStaticTreeCodec3Axis4(HKXReaderConnector connector, int classOffset) throws IOException, InvalidPositionException
	{
		//<member name='nodes' type='hkArray&lt;struct hkcdStaticTreeCodec3Axis4&gt;' ctype='hkcdStaticTreeCodec3Axis4' offset='0' vtype='TYPE_ARRAY' vsubtype='TYPE_STRUCT' arrsize='0' flags='FLAGS_NONE'/>
		...
		if (arrSize > 0) {
			...
			for (int i = 0; i < arrSize; i++) {
				nodes[i] = new hkcdStaticTreeCodec3Axis4(connector, (int)arrValue.to + (i * hkcdStaticTreeCodec3Axis4.size));
			}
		}
	}
}