...
public class BSGeometry extends NiAVObject {
	...
	public boolean readFromStream(ByteBuffer stream, NifVer nifVer) throws IOException {
		...
		//System.out.println("ShaderProperty " + ShaderProperty.ref+" AlphaProperty "+ AlphaProperty.ref);
	...
	public static class BSMesh {
		...
		public BSMesh(int arg, ByteBuffer stream) throws IOException {
			IndicesSize = ByteConvert.readInt(stream);
			NumVerts = ByteConvert.readInt(stream);
			Flags = ByteConvert.readInt(stream);
			//System.out.println("IndicesSize = " + IndicesSize + " NumVerts = " + NumVerts + " Flags = " + Flags);
			if (arg == 0) {

				MeshPath = ByteConvert.readSizedString(stream);
				// looks like this, so no .mesh extension "4eb9e4081f50afc8eff4\5d1c41d3f315483352f5"
				//this is a file in the gemoetries folder adn mesh01.ba2 etc
				// this will need to be loaded and assigned to teh MeshData memebrs on use of this BSGeometry
	...
	/**
	 * <struct name="NiPlane" size="16" module="NiMain"> A plane.
	...
	/**
	 * <struct name="NiBound" module="NiMain"> A sphere. 
