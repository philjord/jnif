...
public  class BSResourceID {
	...
	public BSResourceID(ByteBuffer stream) throws IOException {
		file = ByteConvert.readInt(stream) & 0xffffffffL;
		ext = ByteConvert.readInt(stream) & 0xffffffffL;
		dir = ByteConvert.readInt(stream) & 0xffffffffL;
	}
